...
int main(int argc, char* argv[]) 
{
    ...
    for (i = 1; i < argc; i++) 
    {
        if (strcmp(argv[i], "-m1") == 0) 
        {
            if (m1Flag == 0) 
            {
                ...
                {
                    printf("Error: Missing argument for -m1 option\n");
                    return 1;
                }
            }
            else
        ...
        else if (strcmp(argv[i], "-m2") == 0) 
        {
            if (m2Flag == 0) 
            {
                ...
                {
                    printf("Error: Missing argument for -m2 option\n");
                    return 1;
                }
            }
            else
        ...
        else if (strcmp(argv[i], "-a") == 0)
        {
            if (aFlag == 0) 
            {
                ...
                {
                    printf("Error: Missing argument for - a option\n");
                    return 1;
                }
            }
            else 
    ...
    {
        printf("Error: Options -m1, -m2, and -n are not compatible together\n");
        return 1;
    }

    if (alphabet != NULL && charSet != NULL) 
    {
        printf("Error: Options -a and -C are not compatible together\n");
        return 1;
    }
    ...
    if (charSet != NULL) 
    {
        ...
        for (i = 0; i < strlen(charSet); i++) 
        {
            ...
            case 'S':
                ...
                break;
            default:
                printf("Error: Invalid characters in -C option\n");
                return 1;
            }
        }

        int charSetLength = lowercaseFlag * strlen(lowercase) + uppercaseFlag * strlen(uppercase) + digitsFlag * strlen(digits) + symbolsFlag * strlen(symbols) + 1;  // +1 for null terminator
